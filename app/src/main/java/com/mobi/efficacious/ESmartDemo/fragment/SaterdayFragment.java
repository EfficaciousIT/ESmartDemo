...
public class SaterdayFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) getActivity().findViewById(R.id.saterdayProgressBar);
        listView = (ListView) getActivity().findViewById(R.id.saterday_list);
...
//        Div_id=TimetableActivity_student.divid;
        ...
        satAsync syn = new satAsync();
        syn.execute();
    }

    private class satAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try
            {
                ...
                request.addProperty("day", "Saturday");
