...
public class Student_Chat_Fragment extends Fragment implements SearchView.OnQueryTextListener{
    View myview;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        }else  if (role_id.contentEquals("3"))
        {
            if (!cd.isConnectingToInternet())
            {
                ...
                ChatStudenStandardtAsync chatStudenStandardtAsync = new ChatStudenStandardtAsync();
                chatStudenStandardtAsync.execute();
            }
        }else
        {
//            mfragment.beginTransaction().replace(R.id.contain_main, new CreateGroupFragment()).commit();
                        ...
                        if (response != null) {
                            ...
                            for (int j = 0; j < str1.getPropertyCount(); j++) {
                                ...
                                if (res.contains("No record found")) {
                                    ...
                                    allusers.setUserType_id(role_id);
    ...
    private class ChatStudenStandardtAsync extends AsyncTask<Void, Void, Void> {
        private final ProgressDialog dialog = new ProgressDialog(getActivity());
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                request.addProperty("command", "selectTeacherStandrad");
                        ...
                        if (response != null) {
                            ...
                            for (int j = 0; j < str1.getPropertyCount(); j++) {
                                ...
                                if (res.contains("No record found")) {
                                    ...
                                    allusers.setFCMToken("StandardWiseName");
