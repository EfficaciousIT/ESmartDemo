...
import com.mobi.efficacious.ESmartDemo.dialogbox.Result_Dialog_box;
...
public class Student_Std_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       myview=inflater.inflate(R.layout.activity_syllabus,null);
        ...
        progressBar = (ProgressBar) myview.findViewById(R.id.syllabus_ProgressBar);
        listview = (ListView) myview.findViewById(R.id.standard_Syallbus);
        settings = getActivity().getSharedPreferences(PREFRENCES_NAME, Context.MODE_PRIVATE);
            ...
            try {
                ...
                if (!(envelope.bodyIn instanceof SoapFault)) {
                    ...
                    if (response != null) {
                        ...
                        adapter=new StandardAdapter(mContext,stand,value);
