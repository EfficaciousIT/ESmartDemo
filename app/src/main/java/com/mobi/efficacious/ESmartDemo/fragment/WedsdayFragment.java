...
public class WedsdayFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) getActivity().findViewById(R.id.WedsdayProgressBar);
        listView = (ListView) getActivity().findViewById(R.id.wedsday_list);
...
//        Div_id=TimetableActivity_student.divid;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wedsday, container, false);
    }

    private class wedAsync extends AsyncTask<Void, Void, Void> {
