...
View myview;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myview=inflater.inflate(R.layout.activity_examination,null);
        ...
        value = "Exam";
        progressBar = (ProgressBar) myview.findViewById(R.id.ProgressBar_examination);
        listview = (ListView) myview.findViewById(R.id.standard_listview);
