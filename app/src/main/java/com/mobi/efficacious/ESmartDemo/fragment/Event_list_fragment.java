...
public class Event_list_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            {
                Event1Async adm = new Event1Async();
                adm.execute();
            }else
            {
                ...
                if (!(envelope.bodyIn instanceof SoapFault)) {
                    ...
                    if (response != null) {
                        ...
                        if (response != null) {
                            ...
                            for (int j = 0; j < str1.getPropertyCount(); j++) {
                                ...
                                if (res.contains("No record found")) {
                                    ...
                                    if(role_id.contentEquals("1")||role_id.contentEquals("2")||role_id.contentEquals("3"))
                                    {
                                        ...
                                        {
                                            String event_id=dataList.get(i).get("intEvent_id").toString();
                                            if(str2.getProperty("intEvent_id").toString().trim().contentEquals(event_id))
                                            {
                         ...
                         adapter = new EventListAdapter(getActivity(),diary,"EventList");
    ...
    private class Event1Async extends AsyncTask<Void, Void, Void> {
        private final ProgressDialog dialog = new ProgressDialog(getActivity());
                        ...
                        if (response != null) {
                            ...
                            for (int j = 0; j < str1.getPropertyCount(); j++) {
                                ...
                                if (res.contains("No record found")) {
                                    ...
                                    map.put("intEvent_id", str2.getProperty("intEvent_id").toString().trim());
                                    dataList.add(map);
