package com.mobi.efficacious.ESmartDemo.webservices;
import java.util.ArrayList;

public class Constants
{
	public static final String strWEB_SERVICE_URL="https://e-smarts.net/Demo/DEMOServices/DEMOServices.asmx";
