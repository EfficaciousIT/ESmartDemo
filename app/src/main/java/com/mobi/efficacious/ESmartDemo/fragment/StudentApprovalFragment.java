...
import com.mobi.efficacious.ESmartDemo.adapters.StudentApprovalAdapter;
...
public class StudentApprovalFragment extends Fragment {
    ...
    String School_id;
    String Year_id;
    public StudentApprovalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_studentapproval, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) getActivity().findViewById(R.id.studentapproval_ProgressBar);
        listView = (ListView) getActivity().findViewById(R.id.studentapproval_list);
            ...
            try
            {
                ...
                if(!(envelope.bodyIn instanceof SoapFault))
                {
                    ...
                    if(response != null)
                    {
                        ...
                        if(response!=null)
                        {
                            ...
                            for(int j=0;j<str1.getPropertyCount();j++)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        Leave.setIntStudent_id(str2.getProperty("intStudent_id").toString().trim());
                                    }
                                    if(isValidProperty(str2, "vchProfile"))
                                    {
                                        Leave.setStudentProfile(str2.getProperty("vchProfile").toString().trim());
                                    }
                        ...
                        adapter = new StudentApprovalAdapter(getActivity(), leave);
