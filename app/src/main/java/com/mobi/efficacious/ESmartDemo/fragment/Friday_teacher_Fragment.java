...
public class Friday_teacher_Fragment extends Fragment {
...
TextView text;
    public Friday_teacher_Fragment() {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) getActivity().findViewById(R.id.fridayProgressBar);
        listView = (ListView) getActivity().findViewById(R.id.friday_list);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.friday_teacher, container, false);
    }
