...
public class TeacherApprovalAdapter extends ArrayAdapter<LeaveApproval> {
    ...
    String flag;
    String int_Approval,school_id;
    public TeacherApprovalAdapter(Context context, ArrayList<LeaveApproval> itemsArrayList) {
        super(context, R.layout.fragment_teacherleave, itemsArrayList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.fragment_teacherleave, parent, false);

        TextView fromDate = (TextView)rowView.findViewById(R.id.fromdate_TeacherLeave);
        TextView toDate=(TextView)rowView.findViewById(R.id.ToDate_TeacherLeave);
        TextView Days=(TextView)rowView.findViewById(R.id.Days_TeacherLeave);
        TextView Reason = (TextView)rowView.findViewById(R.id.Reason_TeacherLeave);
        TextView Name = (TextView)rowView.findViewById(R.id.Name_TeacherLeave);
        ...
        String url="https://eserveshiksha.co.in/ESmartDemo/ESmartDemoDemoServices/UploadImages/"+itemsArrayList.get(position).getTeacherProfile()+"";
        ...
        approval_checkbx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                intTeacher_id=itemsArrayList.get(pos).getIntTeacher_id();
                int_Approval="1";
    ...
    private class AdminAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try
            {
                ...
                request.addProperty("intUser_id", intTeacher_id);
                request.addProperty("Usertype", "Teacher");
