...
public class TuesdayFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) getActivity().findViewById(R.id.tuesdayProgressBar);
        listView = (ListView) getActivity().findViewById(R.id.tuesday_list);
...
//        Div_id=TimetableActivity_student.divid;
        tueAsync syn = new tueAsync();
        syn.execute();
    }

    private class tueAsync extends AsyncTask<Void, Void, Void> {
