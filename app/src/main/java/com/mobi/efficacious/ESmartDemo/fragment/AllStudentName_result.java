...
public class AllStudentName_result extends Fragment implements SearchView.OnQueryTextListener{
    View myview;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Standard_id= getArguments().getString("std_id");
        stdname= getArguments().getString("std_name");
        stddivision=getArguments().getString("std_div");
                    ...
                    if(response != null)
                    {
                        ...
                        if(response!=null)
                        {
                            ...
                            for(int j=0;j<str1.getPropertyCount();j++)
                            {
                                ...
                                {
                                    if(isValidProperty(str2, "Standard_name"))
                                    {
                                        allstud.setStandrad_name((str2.getProperty("Standard_name").toString().trim()));

                                    }
                                    if(isValidProperty(str2, "Division_name"))
                                    {
                                        allstud.setDivision_name((str2.getProperty("Division_name").toString().trim()));
                        ...
                        adapter = new AllStudentAdapter(getActivity(),allstudent,"Result");
